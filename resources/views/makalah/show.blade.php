            ...
            <section class="content">
                  ...
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <div class="alert alert-danger alert-dismissable" id="plagiat-alert" style="display:none">
                        ...
                        Maaf proposal yang anda submit, terdeteksi plagiat, Silahkan lihat detail plagiat dibagian bawah halaman ini!
                      </div>
                      ...
                      <div class="box-body">
                        ...
                        <tr>
                          ...
                          <td style="width:70%">
                            ...
                            {!!Form::close()!!}
							              <a title="Download proposal{{ $makalah->id_makalah }}.pdf" class="btn btn-xs btn-default" target="_blank" href="{{ url('makalah/'.$makalah->id_makalah.'/pdf') }}"><i class="fa fa-file-pdf-o"></i></a>
                            <a title="Edit" class="btn btn-xs btn-default" href="{{ url('makalah/'.$makalah->id_makalah.'/edit') }}"><i class="fa fa-edit"></i></a>
                            <a title="Delete" class="btn btn-xs btn-default" onclick="if(confirm('Apakah anda yakin akan menghapus proposal {{ $makalah->id_makalah }}?')){ $('#formdelete{{$makalah->id_makalah}}').submit(); }"><i class="fa fa-close"></i></a>
							@if($makalah->status=='diterima')
							<a title="Plot Dosbing" class="btn btn-xs btn-default" href="{{ url('plotdosen/'.$makalah->id_makalah) }}">plot dosen</a>
							@endif
                            @else
							              <a title="Download proposal{{ $makalah->id_makalah }}.pdf" class="btn btn-xs btn-default" target="_blank" href="{{ url('makalah/'.$makalah->id_makalah.'/pdf') }}"><i class="fa fa-file-pdf-o"></i></a>
                            <a title="Edit" class="btn btn-xs btn-default" href="{{ url('makalah/'.$makalah->id_makalah.'/edit') }}"><i class="fa fa-edit"></i></a>
                        ...
                        <tr>
                          ...
                          <td>{{ $makalah->dosen1 }}</td>
                        </tr>
                        <tr>
                          <th>Dosen Pembimbing 2</th>
                          <td>{{ $makalah->dosen2 }}</td>
                        </tr>
                        <tr>
                          <th>Penulis</th>
              ...
              @endif
                  ...
                  <div class="box box-primary direct-chat direct-chat-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Komentar tentang proposal</h3>
