                    ...
                    <div class="box-header with-border">
                      ...
                      <div class="box-body">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a title="Delete" class="btn btn-xs btn-default" onclick="if(confirm('Apakah anda yakin akan menghapus makalah {{ $makalah1->id_makalah }}?')){ $('#formdelete{{ $makalah1->id_makalah }}').submit(); }"><i class="fa fa-close"></i></a>
              							...
              							<a title="Plot dosen" class="btn btn-xs btn-default" href="{{ url('plotdosen/'.$makalah1->id_makalah) }}">plot dosen</a>
              							@endif
                        ...
                        <tr>
                          ...
                          <td>{{ $makalah1->dosen1 }}</td>
                          <td></td>
                          <td>{{ $makalah2->dosen1 }}</td>
                        </tr>
                        <tr>
                          <th>dosen pembimbing 2</th>
                          <td>{{ $makalah1->dosen2 }}</td>
                          <td></td>
                          <td>{{ $makalah2->dosen2 }}</td>
                        </tr>
                        <tr>
                          <th>Penulis</th>
                          <td>{{ $makalah1->name }}</td>
