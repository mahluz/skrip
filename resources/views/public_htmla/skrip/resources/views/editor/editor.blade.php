            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Data Editor</h3>
                </div><!-- /.box-header -->
                <div class="box-header with-border">
                  ...
                  <a href="{{ url('editor/create') }}" class="btn btn-default bg-green">Tambah Editor <i class="fa fa-plus"></i></a>
                </div>
                <div class="box-body">
                      ...
                      @foreach($users as $user)
                        <tr>
                          ...
                          <td>
                            ...
                            {!!Form::close()!!}
                            <a title="Detail" class="btn btn-xs btn-default" href="{{ url('editor/'.$user->id_user) }}"><i class="fa fa-search"></i></a>
