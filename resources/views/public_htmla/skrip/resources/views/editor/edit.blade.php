              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- <form id="form-editeditor" role="form" method="post" action="{{ url('makalah') }}" onsubmit="setFormSubmitting1()"> -->
                      <div class="box-body">
                  ...
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Edit Password Editor</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    {!!Form::model($user,[
                      'method'  => 'patch',
                      'route'   => ['editor.update',$user->id_user],
                      'id'      => 'form-editpasswordeditor',
...
<!-- jQuery 2.1.4 -->
    ...
    <script type="text/javascript">
      ...
      var serialize1 = $('#form-editeditor').serialize();
      var serialize2 = $('#form-editpasswordeditor').serialize();

      window.onload = function() {
          window.addEventListener("beforeunload", function (e) {
              if (formSubmitting1 && (serialize2 == $('#form-editpasswordeditor').serialize())) {
                  return undefined;
              }

              if (formSubmitting2 && (serialize1 == $('#form-editeditor').serialize())) {
                  return undefined;
              }

              if (serialize1==$('#form-editeditor').serialize() && serialize2==$('#form-editpasswordeditor').serialize()) {
                  return undefined;
              }
