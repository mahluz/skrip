                ...
                <div class="col-xs-12">
                  ...
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Edit Stopword</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    {!!Form::model($stopword,[
                      'method'  => 'patch',
                      'route'   => ['stopword.update',$stopword->kata],
                      'id'      => 'form-editstopword',
                      'onsubmit'=> 'setFormSubmitting()',
                    ])!!}
                    <!-- <form id="form-editstopword" role="form" method="post" action="{{ url('makalah') }}" onsubmit="setFormSubmitting()"> -->
                      <div class="box-body">
                        <div class="form-group {{ $errors->has('kata') ? ' has-error' : '' }}">
                          ...
                          @endif
                          <input type="text" required name="kata" class="form-control" id="kata" placeholder="Kata" value="{{ $stopword->kata }}">
                        </div>
                      </div><!-- /.box-body -->
...
<!-- jQuery 2.1.4 -->
    ...
    <script type="text/javascript">
      ...
      var serialize = $('#form-editstopword').serialize();
      ...
      window.onload = function() {
          window.addEventListener("beforeunload", function (e) {
              ...
              if (serialize==$('#form-editstopword').serialize()) {
                  return undefined;
              }
