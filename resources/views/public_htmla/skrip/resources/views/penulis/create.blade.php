              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form id="form-penulis" required role="form" method="post" action="{{ url('penulis') }}" onsubmit="setFormSubmitting()">
                      {!! csrf_field() !!}
                      <div class="box-body">
...
<!-- jQuery 2.1.4 -->
    ...
    <script type="text/javascript">
      ...
      var serialize = $('#form-penulis').serialize();
      ...
      window.onload = function() {
          window.addEventListener("beforeunload", function (e) {
              ...
              if (serialize==$('#form-penulis').serialize()) {
                  return undefined;
              }
