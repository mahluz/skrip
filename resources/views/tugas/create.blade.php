              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form enctype="multipart/form-data" id="form-mahasiswa" required role="form" method="post" action="{{ url('tugas') }}" onsubmit="setFormSubmitting()">
                      {!! csrf_field() !!}
                      <div class="box-body">
                        <div class="form-group {{ $errors->has('nama_tugas') ? ' has-error' : '' }}">
                          ...
                          @endif
                          <input type="text" required name="nama_tugas" class="form-control" id="nama_tugas" placeholder="Nama Tugas" value="{{ old('nama_tugas') }}">
                        </div>
