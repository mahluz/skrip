            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-header with-border">
                  ...
                  <a href="{{ url('materi/create') }}" class="btn btn-default bg-green">Tambah Mahasiswa <i class="fa fa-plus"></i></a>
                </div>
                <div class="box-body">
                      ...
                      @foreach($users as $user)
                        <tr>
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <ul class="dropdown-menu" role="menu">
                                {!!Form::model($user, [
                                  "method" => "patch",
                                  "route" => ["materi.update",$user->id_user],
                          ...
                          <td>
                            {!! Form::open([
                                'method' => 'delete',
                                'route' => ['mmateri.destroy',$user->id_user],
                                'id' => 'formdelete'.$user->id_user
                            ]) !!}
                            {!!Form::close()!!}
                            <a title="Detail" class="btn btn-xs btn-default" href="{{ url('materi/'.$user->id_user) }}"><i class="fa fa-search"></i></a>
                            <a title="Edit" class="btn btn-xs btn-default" href="{{ url('materi/'.$user->id_user.'/edit') }}"><i class="fa fa-edit"></i></a>
