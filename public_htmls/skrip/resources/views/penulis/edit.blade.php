                ...
                <div class="col-xs-12">
                  ...
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Edit Penulis</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    {!!Form::model($user,[
                      'method'  => 'patch',
                    ...
                    <!-- <form id="form-editpenulis" role="form" method="post" action="{{ url('makalah') }}" onsubmit="setFormSubmitting1()"> -->
                      <div class="box-body">
                  ...
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Edit Password Penulis</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    {!!Form::model($user,[
                      'method'  => 'patch',
                      'route'   => ['penulis.update',$user->id_user],
                      'id'      => 'form-editpasswordpenulis',
...
<!-- jQuery 2.1.4 -->
    ...
    <script type="text/javascript">
      ...
      var serialize1 = $('#form-editpenulis').serialize();
      var serialize2 = $('#form-editpasswordpenulis').serialize();

      window.onload = function() {
          window.addEventListener("beforeunload", function (e) {
              if (formSubmitting1 && (serialize2==$('#form-editpasswordpenulis').serialize())) {
                  return undefined;
              }

              if (formSubmitting2 && (serialize1==$('#form-editpenulis').serialize())) {
                  return undefined;
              }

              if (serialize1==$('#form-editpenulis').serialize() && serialize2==$('#form-editpasswordpenulis').serialize()) {
                  return undefined;
              }
