...
@section('content')
            <section class="content-header">
              <h1>
                Dashboard
                <small>Makalah akan dianggap <span class="badge bg-orange">Plagiat</span> jika terdapat kemiripan dengan makalah lain <span class="badge bg-red">>={{ $persentase }}%</span> pada bagian form <span class="badge bg-green">{{ $form_makalah }}</span></small>
              </h1>
            </section>
            ...
            <section class="content">
                    ...
                    <div class="box-body">
                      ...
                      <ul class="timeline timeline-inverse">
                        ...
                        <?php
                          ...
                          if(strpos($tl->aksi, "editor")>-1 || strpos($tl->aksi, "penulis")>-1 || strpos($tl->aksi, "password")>-1 || strpos($tl->aksi, "profil")>-1 || strpos($tl->aksi, "registrasi")>-1){
                        ...
                        <div class="timeline-item">
                          ...
                          <h3 class="timeline-header no-border">@if(Auth::user()->id_user!=$tl->id_user)<a href="{{ url(($tl->id_role==2?'editor':'penulis').'/'.$tl->id_user) }}">{{ ucwords($tl->name) }}</a> @else Anda @endif{{ $tl->aksi }}. @if(isset($tl->href)) <a href="{{ url($tl->href) }}">Details</a> @endif</h3>
                          @else
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header with-border">
                      <h3 class="box-title">10 Makalah terbaru</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
